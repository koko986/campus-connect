...
public enum ModerationAction {
  ...
  APPROVE_UNIVERSITY_PHOTO("UNIVERSITY_PHOTO"),
  REJECT_UNIVERSITY_PHOTO("UNIVERSITY_PHOTO"),
  APPROVE_OPPORTUNITY("OPPORTUNITY"),
  REJECT_OPPORTUNITY("OPPORTUNITY"),
  VERIFY_STUDENT("ACCOUNT"),
  REJECT_STUDENT_VERIFICATION("ACCOUNT");
